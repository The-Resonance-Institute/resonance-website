...
export const metadata: Metadata = {
  title: "Demos",
  description:
    "Three demonstrations of MORIS: two you use live, the same model answered with and without a conscience and a conscience weighing something you bring it, and a generated record of the same gate judging an autonomous agent's actions before they execute.",
};
...
const demos = [
  ...
  },
  {
    ...
    body:
      "The record of a run, not a live page. An autonomous support agent works a shift of nine tool calls, and every call ran twice: once with nothing between the agent and the effect, once through MORIS. Every figure on the page was produced by the gate, not typed in. Nine calls produced nine different concern levels, which is what govern-is-not-a-switch looks like when you can see it.",
    cta: "Read the record",
  },
  {
    href: "/moris/chat",
    ...
    <div className="mx-auto max-w-5xl px-6">
      <section className="pt-10 pb-12 sm:pt-14">
        ...
        <p className="mt-4 max-w-2xl leading-relaxed text-muted">
          Two of these call the live gate when you use them. The Governed Shift is
          the record of a run through the same gate, generated by the runtime rather
          than written by hand. The gate is mechanical and deterministic. MORIS does not brake the model.
